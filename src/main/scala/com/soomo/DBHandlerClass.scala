...
case class DBHandlerClass():
  def processCommand(
                      commandTarget: String,
                      commandAction: String,
                      parameter: String
                    ): ZIO[DepartmentDao with PositionDao with EmployeeDao with TimesheetDao with PayrollDao with TaxDeductionDao,
    Throwable,
    String
  ] =
    commandTarget match
...
object DBHandlerClass:
  val live: ZLayer[Any, Nothing, DBHandlerClass] =
    ZLayer.succeed(DBHandlerClass())